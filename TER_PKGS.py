...
print('''\033[91m
_______ ______ _____        _____  _  _______  _____      |__   __|  ____|  __ \      |  __ \| |/ / ____|/ ____|
    | |  | |__  | |__) |_____| |__) | ' / |  __| (___          | |  |  __| |  _  /______|  ___/|  <| | |_ |\___ \ 
    | |  | |____| | \ \      | |    | . \ |__| |____) |        |_|  |______|_|  \_\     |_|    |_|\_\_____|_____/
       TOOL DEVELOPER BOSS
''')
def slowprint(s):
    for c in s + '\n' :
...
def slowprint(s):
    for c in s + '\n' :
        ...
        time.sleep(8. / 100)
print("\033[95mї┄─━━━━━━━━━━━━━━━━━━─┄ї")
slowprint('''\033[95m|             Welcome To Hacker BOSS           |
